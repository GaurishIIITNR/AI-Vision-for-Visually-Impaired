...
def configure_genai():
    ...
    if not GOOGLE_API_KEY:
        st.error("Please set your Google Cloud project's Generative AI API key in a `.env` file.")
        return None
...
def get_image_description(image):
    ...
    try:
        ...
        response = model.generate_content(["Explain the description in the image for a blind person, keep it short", pil_image], stream=True)
...
def main():
    ...
    st.title("Image Capture and Description with Generative AI")
